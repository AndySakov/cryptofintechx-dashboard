        ...
        <div className="container d-flex p-md-0">
          ...
          <div className="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <div className="demo-avatar-group">
              <div className="az-img-user avatar-xs">
                <img
              ...
              <div className="az-img-user avatar-sm">
                <img
                  src={require("../../../assets/images/img1.jpg")}
                  className="rounded-circle"
                  alt=""
              ...
              <div className="az-img-user avatar-lg">
                <img
                  src={require("../../../assets/images/img1.jpg")}
                  className="rounded-circle"
                  alt=""
              ...
              <div className="az-img-user avatar-xl d-none d-sm-block">
                <img
                  src={require("../../../assets/images/img1.jpg")}
                  className="rounded-circle"
                  alt=""
              ...
              <div className="az-img-user avatar-xxl d-none d-sm-block">
                <img
                  src={require("../../../assets/images/img1.jpg")}
                  className="rounded-circle"
                  alt=""
